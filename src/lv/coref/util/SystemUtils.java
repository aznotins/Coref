...
public class SystemUtils {
	 ...
	 * 
	 * @param builder
	 *            The ProcessBuilder defining the process to run.
	 */
	 ...
	 * @param error
	 *            Where the process error output should be written. If null, the
	 *            process error output will written to System.err.
	 */
	 ...
	 * 
	 * This should avoid deadlocks where, e.g. the process won't complete
	 * because it is waiting for output to be read from stdout or stderr.
	 * 
	 * @param process
	 *            A running process.
	 * @param outputWriter
	 *            Where to write output. If null, System.out is used.
	 * @param errorWriter
	...
	/**
	 * Runs the shell command which is specified, along with its arguments, in
	...
	/**
	 * Runs the shell command which is specified, along with its arguments, in
	 * the given <code>String</code> array. If there is any regular output, it
	...
	/**
	 * Runs the shell command which is specified, along with its arguments, in
	 * the given <code>String</code>. If there is any regular output, it is
	...
	/**
	 * Runs the shell command which is specified, along with its arguments, in
	 * the given <code>String</code> array. If there is any output, it is
	 * swallowed (!).
	 */
	...
	/**
	 * Runs the shell command which is specified, along with its arguments, in
	 * the given <code>String</code>. If there is any output, it is swallowed
	 * (!).
	 */
	public static void runShellCommand(String cmd) throws IOException {
